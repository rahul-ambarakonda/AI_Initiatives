...
export default function ProjectCard({ project, onOpen }: ProjectCardProps) {
  ...
  return (
    <>
      ...
      >
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r from-cyan-400/10 via-purple-400/10 to-blue-400/10 transition duration-500" />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="inline-flex items-center gap-2 text-gray-600 font-semibold text-sm group-hover:text-indigo-600 transition-all duration-300">
              <span className="relative">
                Read more
                <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-indigo-600 transition-all duration-300 group-hover:w-full" />
              </span>
              <svg
