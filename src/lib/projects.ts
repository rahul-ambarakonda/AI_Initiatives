export const projects = [
  ...
  },
  {
    ...
    title: 'AI SDLC',
    description:
      'An AI-powered software delivery platform that orchestrates the full SDLC, from project intake and Jira planning to coding, testing, security checks, and release review.',
