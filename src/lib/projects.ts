export const projects = [
  ...
  },
  {
    ...
    solution:
      'CodeLens AI acts as an intelligent layer on top of SonarQube. It uses Gemini AI to analyze, filter, and prioritize findings, distinguishing critical vulnerabilities from minor code smells. It provides developers with clear, actionable recommendations and code examples directly within their workflow, transforming code quality management from a reactive chore to a proactive, intelligent process.',
    benefits: [
  ...
  },
  {
    ...
    solution:
      'This system implements a fully automated OODA Loop (Observe-Orient-Decide-Act). It performs pre- and post-conversion scans, orients itself by categorizing issues, uses a Gemini-powered engine to decide on the best healing strategy, and acts by programmatically executing Creo macros. This closed-loop system ensures every conversion is validated, healed, and scored for quality without human intervention.',
    benefits: [
  ...
  },
  {
    ...
    problemStatement: [
      'Software teams spend too much time switching between planning, coding, review, testing, and security tools, which slows down delivery and reduces focus.',
      'Delivery workflows are often fragmented across GitHub, Jira, and supporting systems, making it difficult to keep implementation progress and approvals in sync.',
      'Manual review checks and disconnected workflows make it harder to maintain consistent quality, productivity, and governance across projects.',
    ],
    solution:
      'AI SDLC centralizes the entire software delivery lifecycle into a connected and AI-assisted workflow. The platform integrates project planning, GitHub repositories, AI-driven code generation, intelligent review workflows, testing governance, and release coordination into a single system. Using Claude-powered engineering assistance and contextual repository awareness, developers receive real-time support for code generation, review recommendations, implementation guidance, and productivity optimization. The result is a faster, more transparent, and quality-focused delivery process across engineering teams.',
    benefits: [
      'Accelerate development through AI-assisted code generation and engineering workflows.',
      'Improve developer productivity with contextual GitHub and repository awareness.',
      'Enable intelligent code reviews with AI-powered validation and recommendations.',
      'Reduce manual coordination across planning, coding, testing, and security.',
      'Maintain delivery quality through automated review gates and governance checkpoints.',
      'Integrate Jira, GitHub, Claude, and engineering workflows into one unified platform.',
    ],
    features: [
